...
public class ItemListNinToBinNonRSn extends RecyclerView.Adapter {

    private List<ItemInfoDTO> lstItems;
    OnItemClickListener listener;
    Context context;

    public ItemListNinToBinNonRSn(Context context, List<ItemInfoDTO> lstItems, OnItemClickListener mlistener) {
